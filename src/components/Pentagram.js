...
import { presentationOfPicks } from "../utilis/utilis";
...
const Pentagram = React.memo(({ selectPick }) => {
  ...
  /* Start the presentation after rendered */
  useEffect(() => {
    presentationOfPicks(transition);
  }, []);
  ...
  return (
    <div className="position-relative" ref={transition}>
      <Image
        src={BgPentagon}
        className="d-block mx-auto size "
        alt="pentagon_pattern"
        fluid
      />
